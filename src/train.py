...
def train(version,
            ...
            rot_lim=(-5.4, 5.4), 
            rand_flip=True,
            ncams=5, # choose to drop one camera out of the 6 cameras 
            max_grad_norm=5.0,
            pos_weight=2.13,
            logdir='./runs',
    ...
    if version=='CARLA':
        ...
        # trainloader, valloader= compile_data_CARLA()
        ...
        for epoch in range(nepochs):
            ...
            for batchi, (imgs, rots, trans, intrins, post_rots, post_trans, binimgs) in enumerate(trainloader):
                ...
                rots are rotation of the sensor w.r.t. the 
                trans are translation 
                '''
                
                nparray= binimgs[0,0].cpu().detach().numpy()
                nparray= nparray.astype('int')
                print(nparray)
                img = Image.fromarray((nparray * 255).astype(np.uint8))
                img.save("/home/m/Desktop/LSS.jpg")
