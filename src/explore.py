...
def lidar_check(version,
    ...
    for epoch in range(nepochs):
        for batchi, (orig_imgs, imgs, rots, trans, intrins, post_rots, post_trans, pts, binimgs) in enumerate(loader):
...
def cumsum_check(version,
    ...
    model.eval()
    for batchi, (orig_imgs, imgs, rots, trans, intrins, post_rots, post_trans, binimgs) in enumerate(loader):
